...
_CANONICAL_MODE_KEYS: dict[str, tuple[str, ...]] = {
    "predator_prey": (
        ...
        "predator_rarity_advantage_enabled",
        "predator_rarity_floor",
        "predator_rarity_full_bonus_at",
        "predator_rarity_min_prey",
        "predator_rarity_target_prey_per_predator",
        "predator_rarity_hunt_sense_bonus",
        "predator_rarity_contact_bonus",
        "predator_rarity_depth_transition_bonus",
        "predator_rarity_movement_cost_reduction",
        "prey_flee_sense_multiplier",
        "prey_flee_speed_multiplier",
        ...
        "predator_target_memory_enabled",
        "predator_target_memory_ticks",
        "predator_target_memory_radius_mult",
        "predator_target_switch_score_ratio",
        "predator_memory_steering_mult",
...
_MODE_PARAM_RULES: dict[str, tuple[str, float | int | None, float | int | None]] = {
    ...
    "predator_kill_biomass_bonus": ("float", 0.0, 1.0),
    ...
    "predator_post_move_contact_kill_enabled": ("bool", None, None),
    ...
    "predator_rarity_advantage_enabled": ("bool", None, None),
    "predator_rarity_floor": ("int", 1, None),
    "predator_rarity_full_bonus_at": ("int", 1, None),
    "predator_rarity_min_prey": ("int", 0, None),
    "predator_rarity_target_prey_per_predator": ("float", 0.1, None),
    "predator_rarity_hunt_sense_bonus": ("float", 0.0, 0.25),
    "predator_rarity_contact_bonus": ("float", 0.0, 0.25),
    "predator_rarity_depth_transition_bonus": ("float", 0.0, 0.30),
    "predator_rarity_movement_cost_reduction": ("float", 0.0, 0.20),
    "prey_flee_sense_multiplier": ("float", 0.1, 5.0),
    "prey_flee_speed_multiplier": ("float", 0.75, 2.0),
    "prey_flee_age_slowdown_enabled": ("bool", None, None),
    "prey_flee_low_energy_slowdown_enabled": ("bool", None, None),
    "prey_flee_low_energy_threshold": ("float", 0.01, 1.0),
    "prey_flee_low_energy_min_mult": ("float", 0.4, 1.0),
    "prey_depth_fatigue_enabled": ("bool", None, None),
    "prey_depth_fatigue_min_chase_ticks": ("int", 1, None),
    "prey_depth_fatigue_energy_threshold": ("float", 0.01, 1.0),
    "prey_depth_fatigue_escape_urgency_mult": ("float", 0.1, 1.0),
    "prey_depth_fatigue_decay_ticks": ("int", 1, None),
    "prey_depth_fatigue_max": ("float", 0.0, 1.0),
    "predator_prey_scarcity_penalty_multiplier": ("float", 0.1, 5.0),
    "food_cycle_amplitude": ("float", 0.0, 1.0),
    "predator_near_contact_diagnostic_scale": ("float", 1.0, 5.0),
    "predator_sustained_chase_min_frames": ("int", 1, None),
    "predator_committed_depth_tracking_enabled": ("bool", None, None),
    "predator_committed_depth_tracking_min_chase_ticks": ("int", 1, None),
    "predator_committed_depth_tracking_near_contact_scale": ("float", 1.0, 5.0),
    "predator_committed_depth_tracking_cooldown_ticks": ("int", 0, None),
    "predator_target_memory_enabled": ("bool", None, None),
    "predator_target_memory_ticks": ("int", 1, None),
    "predator_target_memory_radius_mult": ("float", 0.5, 3.0),
    "predator_target_switch_score_ratio": ("float", 0.1, 1.0),
    "predator_memory_steering_mult": ("float", 0.1, 1.0),
...
class Config:
    ...
    def canonical_toml(cls) -> str:
        """Return TOML for committed defaults only, without user overrides."""
