    ...
    try:
        ...
        payload = {
            ...
            "timing_ms": {
                ...
                "kin_line_count": int(metrics.get("kin_line_count", 0.0)),
                "kin_line_max_distance": metrics.get("kin_line_max_distance", 0.0),
                "kin_line_qualifying_lineages": int(metrics.get("kin_line_qualifying_lineages", 0.0)),
                "kin_line_largest_lineage": int(metrics.get("kin_line_largest_lineage", 0.0)),
