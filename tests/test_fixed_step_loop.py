...
from primordial.main import (
    ...
    _get_mouse_input_axis_candidates,
...
class FixedStepLoopTests(unittest.TestCase):
    ...
    def test_get_mouse_input_axis_candidates_include_window_size(self) -> None:
        ...
        with patch(
            ...
            self.assertEqual(
                _get_mouse_input_axis_candidates(renderer),
                ([2560, 1280], [1440, 720]),
            )

    def test_get_mouse_input_axis_candidates_fall_back_to_display_size(self) -> None:
        renderer = SimpleNamespace(display_width=2560, display_height=1440)
