...
expected candidate/baseline evaluation totals, and the adaptive dial values used
during that run. Each completed
...
`exact_tie_revert_candidate`), and the final
